...
<!-- Remove once package updated -->
```{r, warning = FALSE, message = FALSE, echo = FALSE}
devtools::load_all("/home/mike/Documents/Stat Research/Network GSA/GitHub/netgsa")
```
